<h1 align="center">Kayky Souza</h1>

<p align="center">
  Estudante de <strong>Ciência da Computação</strong>.<br/>
  Foco em <strong>Python</strong>, <strong>dados</strong>, <strong>IA</strong> e <strong>infraestrutura</strong> para levar aplicações à produção.
</p>
...
<p align="center">
  O que já está saindo do planejamento: site institucional, identidade visual, agente de IA (Astra),
  estrutura de contato e trilha de infraestrutura para deploy em VPS com Docker, Nginx, PostgreSQL e CI/CD.
</p>
